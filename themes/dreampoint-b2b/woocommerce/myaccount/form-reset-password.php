...
<div class="login-register">
    <div class="container">
        <div class="lr-content">
            ...
            <?php endif; ?>
            <div class="lr-intro">
                <h1><?php esc_html_e( 'Reset password', 'woocommerce' ); ?></h1>
                <p><?php esc_html_e( 'Unesite novu lozinku ispod.', 'dreampoint-b2b' ); ?></p>
            </div>
            <!-- /.lr-intro -->
            ...
            <div class="custom-form">
				<form method="post" class="woocommerce-ResetPassword lost_reset_password">
					...
					<p class="woocommerce-form-row form-row">
						...
						<button type="submit" class="button button--xl button--icon-after woocommerce-Button button<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>" value="<?php esc_attr_e( 'Save', 'woocommerce' ); ?>"><?php esc_html_e( 'Save', 'woocommerce' ); ?></button>
					</p>
