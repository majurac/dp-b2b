=== Product Filter for WooCommerce by WBW - PRO ===
...
To upgrade Product Filter for WooCommerce by WBW plugin free version to the commercial you need to
...
= 3.1.7 - 22/04/2026 =
* Fix - `saveStatistics` permission error.
...
* Dev - Added plugin info to readme.txt.
...
= 3.1.0 - 12/02/2026 =
* Readme.txt - Rename plugin from "WBW Product Filter PRO" to "Product Filter for WooCommerce by WBW - PRO".

= 3.0.9 - 05/02/2026 =
* Dev - Coding standards improved.
* Dev - Rename plugin from "WBW Product Filter PRO" to "Product Filter for WooCommerce by WBW - PRO".

= 3.0.8 - 23/01/2026 =
* Dev - Coding standards improved.

= 3.0.7 - 12/01/2026 =
* Dev - License - Logging - More data added.

= 3.0.6 - 24/12/2025 =
* Dev - "Check for updates" - Action updated (from `wp` to `init`).

= 3.0.5 - 23/12/2025 =
* Dev - "Check for updates" - Action updated (from `admin_init` to `wp`).
...
= 3.0.3 - 25/11/2025 =
* Dev - Changed `curl_setopt()` `$value` parameter to `CURL_SSLVERSION_TLSv1_2` in order to avoid errors such as "cURL error 4: OpenSSL was built without TLS 1.3 support".
...
= 2.9.9 - 10/10/2025 =
* Dev - Added new option "Discourage search engines from indexing" (free plugin version).
...
= 2.9.6 - 22/08/2025 =
* Fix - Text typo fixed.
* Dev - License - Logging authentication error.
* Dev - Coding standards improved.

= 2.9.5 - 20/08/2025 =
* Dev - WP Updater - Server address updated.
* Dev - WP Updater - Reduce the number of requests - Option names updated.
* Dev - "Check for updates" link added (to the Plugins list table).

= 2.9.4 - 15/08/2025 =
* Dev - WP Updater - Server address updated.
* Dev - Alternative licensing server removed.
* Dev - Coding standards improved.
...
= 2.8.9 - 29/07/2025 =
* Dev - WP Updater - Reduce the number of requests.
...
= 2.8.6 - 21/07/2025 =
* Dev - Added alternative server for license activation.
* Dev - Added `aria-label` ("Product Brands").
* Dev - Disable Colors tooltip.
