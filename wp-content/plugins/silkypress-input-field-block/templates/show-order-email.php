<?php
/**
 * Input Fields in the Order Email 
 *
 * This template can be overridden by copying it to yourtheme/silkypress-input-field-block/show-order-email.php
 *
...
?>
<h2><?php esc_html_e( 'Additional Information', 'silkypress-input-field-block' ) ?></h2>
